...
class CycleGANTest:
    ...
    def validation_for_A_dir(self):
        ...
        filePath = self.validation_A_dir
        ...
        # librosa.output.write_wav(path=os.path.join(output_A_dir, os.path.basename(file)),
                                #  y=wav_transformed,
                                #  sr=sampling_rate)
        librosa.output.write_wav(path=os.path.join(output_A_dir, os.path.basename("output.wav")),
                                 y=wav_transformed,
                                 sr=sampling_rate)
        print("finish!")
...
def get_pred():
    ...
    validation_A_dir_default = '/static/snek.wav'
    
    # output_A_dir_default = '../data/vcc2016_training/converted_sound/SF1'
    output_A_dir_default = '/static/conv/'

    model_checkpoint = './cache/model'
...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = './cache/sm1_tf1/logf0s_normalization.npz'
    mcep_normalization_default = './cache/sm1_tf1/mcep_normalization.npz'
    coded_sps_A_norm = './cache/sm1_tf1/coded_sps_A_norm.pickle'
    coded_sps_B_norm = './cache/sm1_tf1/coded_sps_B_norm.pickle'
    
    # model_checkpoint = '../cache/model_checkpoint/'
    model_checkpoint = './cache/sm1_tf1/model_checkpoint_2/_CycleGAN_CheckPoint'
    ...
    validation_A_dir_default = './data/vcc2016_training/SM1/100001.wav'
    
    # output_A_dir_default = '../data/vcc2016_training/converted_sound/SF1'
    output_A_dir_default = './data/vcc2016_training/converted_sound/test_converts/'

    # validation_B_dir_default = '../data/vcc2016_training/evaluation_all/TF2/'
    validation_B_dir_default = './data/vcc2016_training/TF1/100001.wav'
    # output_B_dir_default = '../data/vcc2016_training/converted_sound/TF2/'
    output_B_dir_default = './data/vcc2016_training/converted_sound/test_converts/'
