...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = 'cache/cmu/logf0s_normalization.npz'
    mcep_normalization_default = 'cache/cmu/mcep_normalization.npz'
    coded_sps_A_norm = 'cache/cmu/coded_sps_A_norm.pickle'
    coded_sps_B_norm = 'cache/cmu/coded_sps_B_norm.pickle'
    model_checkpoint = 'cache/cmu/model_checkpoint/'
    resume_training_at = 'cache/cmu/model_checkpoint/_CycleGAN_CheckPoint'
    # resume_training_at = None

    validation_A_dir_default = 'data/cmu_train/cmu_in_250/'
    output_A_dir_default = 'data/cmu_converted/cmu_in/'

    validation_B_dir_default = 'data/cmu_train/cmu_us_250/'
    output_B_dir_default = 'data/cmu_converted/cmu_us/'
