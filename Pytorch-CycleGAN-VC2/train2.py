...
if __name__ == '__main__':
    ...
    model_checkpoint = 'cache/sm1_tf1/model_checkpoint_2/'
    resume_training_at = 'cache/sm1_tf1/model_checkpoint_2/_CycleGAN_CheckPoint'
    # resume_training_at = None

    validation_A_dir_default = 'data/vcc2016_training/SM1/'
    output_A_dir_default = 'data/vcc2016_training/converted_sound/sm1_tf1/SM1'

    validation_B_dir_default = 'data/vcc2016_training/TF1/'
    output_B_dir_default = 'data/vcc2016_training/converted_sound/TF1/'
