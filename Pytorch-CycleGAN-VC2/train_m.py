...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = 'cache/malayalam/logf0s_normalization.npz'
    mcep_normalization_default = 'cache/malayalam/mcep_normalization.npz'
    coded_sps_A_norm = 'cache/malayalam/coded_sps_A_norm.pickle'
    coded_sps_B_norm = 'cache/malayalam/coded_sps_B_norm.pickle'
    model_checkpoint = 'cache/malayalam/model_checkpoint/'
    resume_training_at = 'cache/malayalam/model_checkpoint/_CycleGAN_CheckPoint'
    # resume_training_at = None

    validation_A_dir_default = 'data/malayalam_train/female_9/'
    output_A_dir_default = 'data/malayalam_train/converted_sound/female_9'

    validation_B_dir_default = 'data/malayalam_train/male_17/'
    output_B_dir_default = 'data/malayalam_train/converted_sound/male_17/'
