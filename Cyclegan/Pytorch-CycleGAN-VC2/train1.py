...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = './cache/sf1_tm1/logf0s_normalization.npz'
    mcep_normalization_default = './cache/sf1_tm1/mcep_normalization.npz'
    coded_sps_A_norm = './cache/sf1_tm1/coded_sps_A_norm.pickle'
    coded_sps_B_norm = './cache/sf1_tm1/coded_sps_B_norm.pickle'
    model_checkpoint = './cache/sf1_tm1/model_checkpoint/'
    resume_training_at = './cache/sf1_tm1/model_checkpoint/_CycleGAN_CheckPoint'
    #resume_training_at = None

    validation_A_dir_default = './data/vcc2016_training/SF1/'
    output_A_dir_default = './data/vcc2016_training/converted_sound/sf1_tm1/SF1/'

    validation_B_dir_default = './data/vcc2016_training/TM1/'
    output_B_dir_default = './data/vcc2016_training/converted_sound/sf1_tm1/TM1/'
